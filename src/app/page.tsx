...
const HomeContent = () => {
  ...
  const { loading, filteredEmployees, searchTerm, setSearchTerm,setPriorityBased } = useEmployees();
    ...
    <main className="flex flex-col gap-4">
      <div className="flex gap-4 flex-wrap">
        ...
        <div>
          ...
          <select name="priority" id="priority" defaultValue={"all"} className="bg-gray-100 px-4 py-2 border-none outline-none" onChange={handlePriority}>
